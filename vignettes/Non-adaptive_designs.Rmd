...
```{r plot bias, echo=FALSE, fig.height=4, fig.width=6}
...
This effect decreases as _N_ increases. For example, when _N=1000_ (note change in scale):



```{r plot bias n1000, echo=FALSE, fig.height=4, fig.width=6}
N <- 1000
naive <- pwbias <- precision <- numeric(length(theta.vec))
