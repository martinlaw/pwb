...
smaller.kbl <- kbl(smaller.table,
                      ...
                      digits = 1, 
                      align="rrr",
                      caption="Detailed bias and MCSE results for individual studies (multiplied by 100,000).",
                      booktabs = T,
                      col.names = c(" ", "Unconditional", "PWB", "MCSE"),
...
bias.wide <- data.frame(1e5*ma.bias.ex, 
                        ...
                        1e5*ma.bias.inc,
                        1e5*ma.mcse.inc,
                        1e5*(ma.bias.inc-ma.bias.ex),
                        fraction, fraction.pwb, 
...
summary.kbl <- kbl(bias.wide,
                      format="latex", 
                      digits = c(1, 1, 1, 1, 1, 2, 2, 2, 1, 1, 2), 
                      align="r",
                      caption="Detailed bias and MCSE results for meta-analysis (multiplied by 100,000) and $W_S$Simon, where $W_S$ is the weight of the Simon design in the meta-analysis given $\\sum W_i=1$. ``Precision'' is ratio of mean precision of Simon design and mean precision of remaining studies.",
                      booktabs = T,
                      col.names = c("Bias", "MCSE", "Bias", "MCSE", "$\\Delta$", "Uncond.", "PWB", "$W_S$", "Uncond.", "PWB", "Precision"),
                      label="summary.bias",
                      escape=FALSE)
summary.kbl <- add_header_above(summary.kbl,
                                header=c("Excluding" = 2,
                                         "Including" = 2,
                                         " "=1,
                                         "$\\\\vert \\\\Delta \\\\vert$/bias"=2,
                                         " "=1,
                                         "$W_S$Simon"=2,
                                         " "=1),
                                escape = FALSE)
summary.kbl <- add_header_above(summary.kbl, c("Meta-analysis" = 5, "Simon" = 6))
