...
ktab <- kbl(results,
            ...
            digits = 0, 
            align="rrrrrrrrrr",
            caption="Summary of results (multiplied by 100,000). \\%Simon is absolute increase in meta-analysis bias as percentage of unconditional bias of Simon design.",
            booktabs = T,
            col.names = c("$\\theta$", "Uncond.", "PWB", "", "Exc.", "Inc.", "%Simon",  "Exc.", "Inc."),
            label="ma_add_trial")
ktab <- add_header_above(ktab, header = c(" "=1, "Bias"=2, "MCSE"=1, "Bias exc./inc. Simon"=3, "MCSE"=2))
