...
```{r simon MA plot, fig.height=4, fig.width=6, echo=FALSE, warning=T}
library(ggplot2)
...
```
```{r simon plot 2, fig.height=4, fig.width=6, echo=FALSE, warning=T}
...
```{r simon plot low, fig.height=4, fig.width=6, echo=FALSE, warning=T}
